...
public class MerchantSellerActivity extends AppCompatActivity {
    ...
    private MerchantSellerAdapter merchantAdapter; // จีดการข้อมูลใน Recycler Viewer
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.merchant_seller_page); //กำหนดหน้า layout home
        ...
        menu_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PopupMenu popupMenu = new PopupMenu(MerchantSellerActivity.this, v);
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (id == R.id.menu_profile){
                            Intent intent = new Intent(MerchantSellerActivity.this, ProfileActivity.class);
                            startActivity(intent);
                            return true;
                        } else if (id == R.id.menu_logout){
                            LogoutUtils.logout(MerchantSellerActivity.this, sharedPreferences);
                            return true;
                        }
                        return false;
                    }
        ...
        try {
            ...
            e.printStackTrace();
            Log.e("MerchantSellerActivity", "Error initializing: " + e.getMessage());
        }
        ...
        BACKBTN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(MerchantSellerActivity.this)
    ...
    private void loadMerchantData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Api.URL_GET_MERCHANT, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (!merchantList.isEmpty()) {
                        merchantAdapter = new MerchantSellerAdapter(MerchantSellerActivity.this, merchantList);
                        rvMerchant.setAdapter(merchantAdapter);
                        Log.d("API_DEBUG", "Successfully set adapter with " + merchantList.size() + " games");
                    } else {
                        Toast.makeText(MerchantSellerActivity.this, "No games found", Toast.LENGTH_SHORT).show();
                    }

                } catch (Exception e) {
                    Log.e("API_DEBUG", "Error parsing data: " + e.getMessage());
                    e.printStackTrace();
                    Toast.makeText(MerchantSellerActivity.this, "Error loading data: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(MerchantSellerActivity.this, "Network Error", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void initializeViews() {
        try {
            ...
            if(rvMerchant == null){
                Log.e("MerchantSellerActivity", "RecyclerView not found");
            }else {
                Log.d("MerchantSellerActivity", "RecyclerViewer initialized successfully");
            }
        } catch (Exception e){
            Log.e("MerchantSellerActivity", "Error initializing views: " + e.getMessage());
        }
